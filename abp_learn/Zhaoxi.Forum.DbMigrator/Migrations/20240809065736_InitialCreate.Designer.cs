...
namespace Zhaoxi.Forum.DbMigrator.Migrations
{
    ...
    [Migration("20240809065736_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Zhaoxi.Forum.Domain.Topic.PostsEntity", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("Zhaoxi.Forum.Domain.TopicEntity", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("Zhaoxi.Forum.Domain.Topic.PostsEntity", b =>
                {
                    b.HasOne("Zhaoxi.Forum.Domain.TopicEntity", "Topic")
                        .WithMany("Postses")
